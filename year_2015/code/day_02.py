def day_02(input_str):
    ...
    for dimensions in input_array:
        side_areas = (dimensions[0]*dimensions[1], dimensions[1]*dimensions[2], dimensions[0]*dimensions[2])
    ...
    for dimensions in input_array:
        dimensions.sort()
        total_length += 2 * (dimensions[0] + dimensions[1]) + dimensions[0]*dimensions[1]*dimensions[2]
